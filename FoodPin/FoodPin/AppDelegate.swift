...
//            27.0/255.0, alpha: 1.0)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "Auto.CoreDataDemo" in the application's documents Application Support directory.
